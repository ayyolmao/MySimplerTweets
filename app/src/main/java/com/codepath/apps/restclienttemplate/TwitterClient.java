...
public class TwitterClient extends OAuthBaseClient {
	...
	public void getHomeLinetime(AsyncHttpResponseHandler handler, int since) {
	...
	public void sendRetweet(Long statusId, AsyncHttpResponseHandler handler) {
	...
	public void undoRetweet(Long statusId, AsyncHttpResponseHandler handler) {
	...
	public void sendLike(Long statusId, AsyncHttpResponseHandler handler) {
	...
	public void undoLike(Long statusId, AsyncHttpResponseHandler handler) {
